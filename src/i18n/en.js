export const en = {
  ...
  settings: {
    ...
    logoRequiredDesc: 'This template was saved with a brand logo. Upload one to match the original layout.',
    uploadLogoBtn: 'Upload Logo',
    logoTooLarge: 'File too large. Please use a logo under 1MB.',
    fillRequired: 'Fill image required',
    fillRequiredDesc: 'This template uses image fill. Upload an image to apply it to codes.',
    uploadFillBtn: 'Upload Fill Image',
    fillTooLarge: 'File too large. Please use an image under 2MB.',
    fillLoaded: 'Fill image loaded',
    fillImageTitle: 'Code fill image',
    fillImageSub: 'Applied to all code types',
    removeFillImage: 'Remove fill image',
    codeColorTitle: 'Code Color',
    codeColorDesc: 'Choose color or image fill.',
    solidColor: 'Solid Color',
    imageFill: 'Image Fill',
    colorPicker: 'Color Picker',
    hex: 'Hex',
    assetBrandLogo: 'brand logo',
    assetFillImage: 'fill image',
    andWord: 'and',
    templateRequiresAssets: 'Template requires {assets}. Upload required assets in Export Settings first.',
    position: 'Position',
  ...
  labels: {
    ...
    labelsReadyZero: '0 codes ready',
    labelsReadySingular: '{count} code ready',
    labelsReadyPlural: '{count} codes ready',
    clear: 'Clear',
    export: 'Export',
